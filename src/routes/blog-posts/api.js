...
module.exports = {
  createNewBlogPost: function(title, urlTitle, dateTimestamp,
  ...
  editBlogPost: function(id, title, urlTitle,
      dateTimestamp, tags, thumbnailImageUrl,
      markdownContent, seoTitleTag, seoMetaDescription, callback) {
    const arrayOfTags = tags.split(',').map(function(tag) {
      return tag.trim();
    });
